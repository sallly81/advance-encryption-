...
namespace WindowsFormsApplication4
{
    ...
    public static string tobin8(long a) {
        string b = "";
        for (int i = 1;i <= 8; i++) {
            b = ((a % 2)+ b);
            a = a/2;
    ...
    public static string tobin4(long a) {
        string b = "";
        for (int i = 1; i <= 4; i++) {
            b = ((a % 2) + b);
            a = a/2;
    ...
    public static string Xor128(string a, string b) {
        string x = "";
        for (int i = 1; i <= 128; i++) {
    ...
    public static long aes (string a) {
        ...
        for (int i=a.Length-1;i>0;i--)
        {
            ...
            double xx = (Math.Pow(2,z));
            int x1=Convert.ToInt32(xx);

               x= (Convert.ToInt32(a.Substring(i,1)) * x1 ) + x; 
               z++;
    ...
    public static string shift(string s, int  b, string  m) {
        int l = s.Length;
        if ((m == "l")) {
            for (int j = 0; (j 
                        <= (b - 1)); j++) {
            ...
            for (int j = 0; (j 
                        <= (b - 1)); j++) {
                object t = s.Substring((l - 1), 1);
                for (int i = l; (i <= 2); i = (i-1)) {
                   object t= s.Substring((i - 1), 1) ;
                    t = s.Substring(i, 1);
                }
    ...
    public static string binaryhex(string hexnumber) {
        string BinaryNumber = "";
    ...
    public static string xorhex(string a, string b, string c, string d) {
        string x = "";
        for (int i = 1; (i <= 8); i++) {
    ...
    public static string mixcolumns(string ab)
{
    ...
    string[,] a = { { "02", "03", "01", "01" }, { "01", "02", "03", "01" }, { "01", "01", "02", "03" }, { "03", "01", "01", "02" } };
        ...
        for (mn = 0; (mn <= 3); mn++) {
            for (int i = 1; (i <= ab.Length); i = (i + 8)) {
                ...
                m = Convert.ToInt32(c.Substring(0, 4));
               m1 = Convert.ToInt32(c.Substring(4, 4));
            ...
            hex1 = l[m, m1];
               ...
               string ff= w.Substring(0, 1);
               f= Convert.ToInt32(ff);
               string ff1 = w.Substring(0, 1);
               f1 = Convert.ToInt32(f);
                ...
                int result = ((int1 + int2) 
                            % 255);
                string hexResult = Convert.ToString(result);
             int qq = hexResult.Length;
                ...
                p = ee[Convert.ToInt32(kk), Convert.ToInt32(k)];
                y = binaryhex(p);
                t = (t + y);
    ...
    public static string mixcolumnsinverse(string s) {
       
      string[,] ee=  {{"01", "03", "05", "0F", "11", "33", "55", "FF", "1A", "2E", "72", "96", "A1", "F8", "13", "35"}, {"5F", "E1", "38", "48", "D8", "73", "95", "A4", "f7", "02", "06", "0A", "1E", "22", "66", "AA"}, {"E5", "34", "5C", "E4", "37", "59", "EB", "26", "6A", "BE", "D9", "70", "90", "AB", "E6", "31"}, {"53", "F5", "04", "0C", "14", "3C", "44", "CC", "4F", "D1", "68", "B8", "D3", "6E", "B2", "CD"}, {"4C", "D4", "67", "A9", "E0", "3B", "4D", "D7", "62", "A6", "F1", "08", "18", "28", "78", "88"}, {"83", "9E", "B9", "D0", "6B", "BD",
" }, { "97", "B2", "87", "90", "61", "BE", "DC", "FC", "BC", "95", "CF", "CD", "37", "3F", "5B", "D1" }, { "53", "39", "84", "3C", "41", "A2", "6D", "47", "14", "2A", "9E", "5D", "56", "F2", "D3", "AB" }, { "44", "11", "92", "D9", "23", "20", "2E", "89", "B4", "7C", "B8", "26", "77", "99", "E3", "A5" }, { "67", "4A", "ED", "DE", "C5", "31", "FE", "18", "0D", "63", "8C", "80", "C0", "F7", "70", "07" } };
      string[,] a1  = {{"0e", "0b", "0d", "09"}, {"09", "0e", "0b", "0d"}, {"0d", "09", "0e", "0b"}, {"0b", "0d", "09", "0e"}};
        ...
        for (mn = 0; (mn <= 3); mn++) {
            for (int i = 1; (i <= s.Length); i = (i + 8)) {
                ...
                hex2 = l[Convert.ToInt32(z), Convert.ToInt32(z1)];
                int int1 = Convert.ToInt32(hex1, 16);
                int int2 = Convert.ToInt32(hex2, 16);
                int result = ((int1 + int2) 
                            % 255);
    ...
    public static string inverssubbyte(string a) {
        ...
        for (j = 1; (j <= a.Length); j = (j + 8)) {
            ...
            tt1 = Convert.ToInt32(s1);
            t11 = Convert.ToInt32(ss1);
            r1 = uu[tt1, t11];
            z = r1.Length;
            if ((z == 1)) {
                r1 = ("0" + r1);
    ...
    public static string add(string a, string key) {
        string z;
        string f;
        string k;
        z = "";
        ...
        for (int i = 1; (i <= z.Length); i = (i + 4)) {
            m = Convert.ToInt32(z.Substring((i - 1), 4));
            if ((m == 10)) {
                k = "A";
            }
            else if ((m == 11)) {
    ...
    public static string addinvers(string b, string key) {
        string z;
        z = Xor128(b, key);
        return z;
    }
    ...
    public static string mix(string a) {
        ...
        for (i = 1; (i <= 128); i = (i + 32)) {
            r = (r + mixcolumns(a.Substring((i - 1), 32)));
        }
        
        return r;
    }
    
    public static string  mixinvers(string a) {
        int i;
        string r;
        r = "";
        for (i = 1; (i <= 128); i = (i + 32)) {
            r = (r + mixcolumnsinverse(a.Substring((i - 1), 32)));
        }
    ...
    public  string  aesencryption(string a, string key) {
       string d = binary(a);
        a = d;
        string n;
        string v;
    ...
    public string aesdecryption(string a, string key) {
        string m;
        string s;
        string n;
        string v;
    ...
    public static string  completeencryption(string a, string key) {
        string vv;
        string newvv;
        string complete;
        string encryption;
        ...
        int length;
        int kk;
        for (int ff = 1; (ff <= a.Length); ff = (ff + 16)) {
            vv = a.Substring((ff - 1), 16);
            if ((vv.Length == 16)) {
                encryption = (encryption + aesencryption(vv, key));
            }
                ...
                newvv = (vv + complete);
                encryption = (encryption + aesencryption(newvv, key));
            }
    ...
    public static string completedecryption(string a, string key) {
        string decryption;
        string vv;
        string newvv;
        string complete;
    ...
    public string  bin_word(string t) {
        string mm;
        string z;
        string zz;
        zz = "";
